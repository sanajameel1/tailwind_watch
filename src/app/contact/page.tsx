...
const Contact = () => {
  return (
    <section className='contact-from border max-w-lg mx-auto my-20 p-8 bg-white shodow-md rounded-md'>
        ...
        <form>
            ...
            <textarea placeholder='Your Message' className='w-full mb-4 px-4 py-2 2 border border-blue-500 rounded-md' rows={5} required></textarea>
